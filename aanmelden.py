...
# s_height_value = heigth_value * 0.8
# s_width_value = width_value * 0.4
...
l1 = tk.Label(topFrame, text="Naam", font=('Ariel', 16, 'italic'),bg="brown").grid(row=2, column=0,padx=10)
l2 = tk.Label(topFrame, text="Status", font=('Ariel', 16, 'italic'),bg="yellow").grid(row=2, column=1,padx=(25,25))
l3 = tk.Label(topFrame, text="Glijtijd", font=('Ariel', 16, 'italic'),bg="green").grid(row=2, column=2,padx=(25,25))
l4 = tk.Label(topFrame, text="Set", font=('Ariel', 16, 'italic'),bg="red").grid(row=2, column=4,padx=(25,10))
...
progBarVar = IntVar()
progBar = ttk.Progressbar(bottomFrame, orient=HORIZONTAL, length=110, var=progBarVar)
...
def knoppen():
    ...
    if fil_lijst == []:
        ...
        for item in fil_lijst:
            ...
            b = tkMac.Button(middleFrame, text="Afgemeld", fg="black", padx=8, pady=8, bg=item.bg, width=80,
            ...
            t = tkMac.Button(middleFrame, text="Tijd", fg="black", padx=16, pady=16, width=25, height=25,
                             highlightbackground="white")
...
techniekers = tk.Menu(menuBar)
about = tk.Menu(menuBar)
cluster = tk.Menu(menuBar)
...
for item in fil_lijst:
    i = 3
    # Labels voor de drukknoppen maken
    label = tk.Label(middleFrame, text=item.volledigeNaam).grid(row=i, column=0, sticky="e")
    # Drukknoppen maken (pad hier geef je de grote van de knop mee weer)
    b = tkMac.Button(middleFrame, text="Afgemeld", fg="black", padx=8, pady=8, bg=item.bg, width=80,
                     highlightbackground="white")
    b["command"] = lambda b=b, item=item: meldAan(b, item, labelStatus)
...
# buskot = tkMac.Button(middleFrame, text="Uit", font=("Ariel", 20, "italic"), pady=20, width=80, height=30,
#  bg="red", highlightbackground="white", anchor="center")

# lblBuskot = tk.Label(middleFrame, text="Buskot is uit dienst!", font=("Ariel", 20, "italic"), pady=20)
